Contributing to DotOracle's smart contracts
=======
...
```
cd dto-contracts
git remote add upstream https://github.com/dotoracle/bridge-contracts.git
git fetch upstream
git pull --rebase upstream master
```
NOTE: The directory `dto-contracts` represents your fork's local copy.
...
5) Go to [github.com/dotoracle/bridge-contracts.git](https://github.com/dotoracle/bridge-contracts.git) in your web browser and issue a new pull request.
