...
contract DTOBridgeToken is ERC20Burnable, BlackholePrevention, IDTOTokenBridge, Ownable, ChainIdHolding {
    using SafeMath for uint256;
	mapping(bytes32 => bool) public alreadyClaims;
	address public originalTokenAddress;
	uint8 _decimals;
	constructor(address _originalTokenAddress, string memory _tokenName, string memory _tokenSymbol, uint8 __decimals) ERC20(_tokenName, _tokenSymbol) public{
